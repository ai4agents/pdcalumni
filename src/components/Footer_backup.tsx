                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        <div className="flex items-center gap-3 mb-6">
                            <div className="w-10 h-10 relative flex items-center justify-center">
                                <Image src="/logo.webp" alt="Priyadarshini Colleges Logo" fill className="object-contain" />
                            </div>
                            <div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            ...
                            <FooterLink href="/about" label="About Priyadarshini" />
                            <FooterLink href="/directory" label="Alumni Directory" />
                            <FooterLink href="/events" label="News & Events" />
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            <FooterLink href="/community" label="Stories & Humour" />
                            <FooterLink href="/jubilee" label="Silver Jubilee Celebration" />
